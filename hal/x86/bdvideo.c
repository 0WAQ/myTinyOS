...
sint_t bga_ioctrl(void *ghpdev, void *outp, uint_t iocode) { return -1; }
...
sint_t bga_set_bank(void *ghpdev, sint_t bnr) { return -1; }
pixl_t bga_readpix(void *ghpdev, uint_t x, uint_t y) { return 0; }
...
pixl_t bga_dxreadpix(void *ghpdev, uint_t x, uint_t y) { return 0; }
...
size_t vbe_read(void *ghpdev, void *outp, size_t rdsz) { return rdsz; }
size_t vbe_write(void *ghpdev, void *inp, size_t wesz) { return wesz; }
sint_t vbe_ioctrl(void *ghpdev, void *outp, uint_t iocode) { return -1; }
...
sint_t vbe_set_bank(void *ghpdev, sint_t bnr) { return -1; }
pixl_t vbe_readpix(void *ghpdev, uint_t x, uint_t y) { return 0; }
...
pixl_t vbe_dxreadpix(void *ghpdev, uint_t x, uint_t y) { return 0; }
...
sint_t vbe_set_xy(void *ghpdev, uint_t x, uint_t y) { return -1; }
sint_t vbe_set_vwh(void *ghpdev, uint_t vwt, uint_t vhi) { return -1; }
sint_t vbe_set_xyoffset(void *ghpdev, uint_t xoff, uint_t yoff) { return -1; }
sint_t vbe_get_xy(void *ghpdev, uint_t *rx, uint_t *ry) { return -1; }
sint_t vbe_get_vwh(void *ghpdev, uint_t *rvwt, uint_t *rvhi) { return -1; }
sint_t vbe_get_xyoffset(void *ghpdev, uint_t *rxoff, uint_t *ryoff) { return -1; }
